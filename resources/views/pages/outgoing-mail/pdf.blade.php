...
<head>
  ...
  <title>Surat Keluar #{{ $data->file_number}}</title>
  <style>
		body {
      width: 100%;
				...
				<td colspan="3" height="270" valign="top">
					<div align="justify" style="margin-top: 30px; margin-bottom:30px;">
						...
						<table border="0" style="width: 352px;  margin:20px 0;">
							<tbody>
								<tr>
									<td width="80"><span style="font-size: 12px;">Tanggal/Jam</span></td>
									<td width="10"><span style="font-size: 12px;">:</span></td>
									<td width="248"><span style="font-size: 12px;">{{ $data->created_at->format('d F Y / H:i') }}</span></td>
								</tr>
								<tr>
