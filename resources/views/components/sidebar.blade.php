    ...
    [
        "href" => [
            ...
            [
                ...
                "section_list" => [
                    ["href" => "surat-masuk", "text" => "Data Surat Masuk"],
                    ["href" => "surat-masuk.new", "text" => "Buat Surat Masuk"]
                ]
            ],
            [
                "section_text" => "Surat Keluar",
                "section_list" => [
                    ["href" => "surat-keluar", "text" => "Data Surat Keluar"],
                    ["href" => "surat-keluar.new", "text" => "Buat Surat Keluar"]
                ]
            ]
        ],
        "text" => "Master Data",
